...
- **Периодические напоминания** — ежечасно, ежедневно, еженедельно, ежемесячно, ежегодно
...
архивировать отчёт в 18:00 еженедельно
оплатить счёт 1 числа в 10:00 ежемесячно
заплатить налог 20 ноября в 10:00 ежегодно
бэкап данных в 3:00 каждый час
```

| Ключевые слова | Тип |
|---|---|
| `ежечасно`, `каждый час`, `раз в час`, `каждые 60 минут` | hourly |
| `ежедневно`, `каждый день`, `раз в день`, `каждые сутки`, `раз в сутки` | daily |
| `еженедельно`, `каждую неделю`, `раз в неделю`, `каждые 7 дней` | weekly |
| `ежемесячно`, `каждый месяц`, `раз в месяц`, `каждое NN числа` | monthly |
| `ежегодно`, `каждый год`, `раз в год` | yearly |
